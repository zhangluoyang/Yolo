...
def get_data_set(param: Union[Yolo7Param]) -> Tuple[BasicDataSet, BasicDataSet]:
    """
    :param param:
    :return:
    """
...
def main():
    ...
    param.pretrain_path = "/home/zhangluoyang/Desktop/model/yolov7_backbone_weights.pth"
    ...
    model.fit(epochs=param.epochs,
              ...
              start_step=0,
              collate_fn=collate_fn_utils.yolo_v7_collate_fn,
              model_name="yolo_v7_l")
