...
from luoyang.param.Param import Yolo3Param, Yolo4Param, Yolo5Param
...
parser.add_argument('--train_path', default="/home/zhangluoyang/dataset/all_voc_train.txt")
parser.add_argument('--eval_path', default="/home/zhangluoyang/dataset/all_voc_test.txt")
parser.add_argument('--model_path', default=None)
parser.add_argument('--num_workers', default=2)


def get_data_set(param: Union[Yolo4Param, Yolo3Param, Yolo5Param]) -> Tuple[BasicDataSet, BasicDataSet]:
    """
    :param param:
    :return:
    """
...
def main():
    ...
    param = Yolo3Param()
    param.darknet53_weight_path = "/home/zhangluoyang/dataset/darknet53_weights.pth"
