...
def get_data_set(param: Union[Yolo5PoseParam]) -> Tuple[BasicDataSet, BasicDataSet]:
    """
    :param param:
    :return:
    """
    ...
    train_transformers = transformer_utils.get_yolo_v5_pose_train_transformer(param=param)
    test_transformers = transformer_utils.get_yolo_v5_pose_test_transformer(param=param)
...
def main():
    ...
    param.darknet_csp_weight_path = "/home/zhangluoyang/Desktop/model/yolov5_m.pth"
    param.nms_threshold = 0.5
    param.conf_threshold = 0.05
    yolo_task = YoloV5Pose(param=param)
    ...
    model.fit(epochs=param.epochs,
              ...
              start_step=0,
              collate_fn=collate_fn_utils.yolo_v5_v2_collate_fn,
              model_name="yolo_v5_m_pose")
