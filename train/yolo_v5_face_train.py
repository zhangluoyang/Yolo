...
def get_data_set(param: Union[Yolo5FaceParam]) -> Tuple[BasicDataSet, BasicDataSet]:
    ...
    train_transformers = transformer_utils.get_yolo_v5_face_train_transformer(param=param)
    test_transformers = transformer_utils.get_yolo_v5_face_test_transformer(param=param)
...
def main():
    ...
    model.compile(loss_layers=loss_layers,
                  ...
                  device_num=2 if args.parallel else 1,
                  early_stop=1000)
