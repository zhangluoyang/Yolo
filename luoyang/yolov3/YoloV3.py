...
from luoyang.yolov3.YoloV3BackBone import YoloV3BackBone
from luoyang.yolov3.YoloTarget import YoloTarget
...
class YoloV3(TaskLayer):
    ...
    def __init__(self, param: Yolo3Param):
        ...
        self.body_net = YoloV3BackBone(output_size=self.body_output_size * 3,
    ...
    def to_onnx(self, onnx_path: str):
        ...
        data = torch.rand(size=(1, 3, self.param.img_size, self.param.img_size)).cpu()
        input_names = ["images"]
