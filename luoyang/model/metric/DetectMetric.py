...
import luoyang.utils.anchor_utils as anchor_utils
import luoyang.utils.metric_utils as metric_utils
...
class DetectMetric(MetricLayer, ABC):
    ...
    def __init__(self,
        ...
        super(DetectMetric, self).__init__(name=name)
    ...
    def metric_feed_forward(self, tensor_dict: Dict[str, Union[torch.Tensor, Any]],
        ...
        :return:
        """
        # [b, ?, (min_x, min_y, max_x, max_y, obj_conf, cls_conf, cls)]
